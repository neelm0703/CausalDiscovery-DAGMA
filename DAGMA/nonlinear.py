...
class DagmaMLP(nn.Module): 
    ...
    def __init__(self, dims: typing.List[int], bias: bool = True, dtype: torch.dtype = torch.float):
        r"""
        Parameters
        ----------
...
class DagmaNonlinear:
    ...
    def minimize(self, 
        ...
        for i in range(max_iter):
            ...
            self.loss_history.append(score.item())
            pbar.update(1)
        return True
...
def test():
    ...
    W_df.to_csv("DAGMA_nonlinear_W_est.csv")
